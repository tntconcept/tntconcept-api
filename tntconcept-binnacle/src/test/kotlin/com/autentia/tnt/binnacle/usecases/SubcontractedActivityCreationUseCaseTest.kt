...
//    private val sendPendingApproveActivityMailUseCase = mock<SendPendingApproveActivityMailUseCase>()
    ...
    fun `create activity with a nonexistent projectRol throws an exception`() {
        ...
        assertThrows<ProjectRoleNotFoundException> {
            SubcontractedActivityCreationUseCase.createSubcontractedActivity(SUBCONTRACTED_ACTIVITY_NO_APPROVAL_REQUEST_BODY_DTO, Locale.ENGLISH)
        }
    }
    ...
    fun `create activity with incomplete evidence information throws an exception`(
        ...
        assertThrows<NoEvidenceInActivityException> {
            SubcontractedActivityCreationUseCase.createSubcontractedActivity(subcontractedActivityRequest, Locale.ENGLISH)
        }
    ...
    fun `create activity before project creation date throws an exception`() {
        ...
        assertThrows<ActivityBeforeProjectCreationDateException> {
            SubcontractedActivityCreationUseCase.createSubcontractedActivity(SUBCONTRACTED_ACTIVITY_WITH_DATE_BEFORE_CREATION_PROJECT_DATE, Locale.ENGLISH)
        }
    ...
    fun `created activity with no approval required and with no evidence`() {
        ...
        val activityCreated = SubcontractedActivityCreationUseCase.createSubcontractedActivity(SUBCONTRACTED_ACTIVITY_NO_APPROVAL_REQUEST_BODY_DTO, Locale.ENGLISH)
    ...
    fun `create activity with interval of natural days`() {
        ...
        val result = SubcontractedActivityCreationUseCase.createSubcontractedActivity(SUBCONTRACTED_ACTIVITY_NO_APPROVAL_REQUEST_BODY_DTO, Locale.ENGLISH)
    ...
    fun `created activity with evidence and no approval required for project role, none mail is sent`() {
        ...
        val activityCreated = SubcontractedActivityCreationUseCase.createSubcontractedActivity(SUBCONTRACTED_ACTIVITY_WITH_EVIDENCE_DTO, Locale.ENGLISH)
    ...
    fun `created activity with evidence and approval required with evidence, pending approval mail is sent`() {
        ...
        // When
        val activityCreateRequest = SUBCONTRACTED_ACTIVITY_WITH_EVIDENCE_DTO.copy(projectRoleId = projectRoleRequireEvidence.id)

        val activityCreated = SubcontractedActivityCreationUseCase.createSubcontractedActivity(activityCreateRequest, Locale.ENGLISH)
    ...
    private companion object {
        ...
        private val SUBCONTRACTED_ACTIVITY_NO_APPROVAL_REQUEST_BODY_DTO = SubcontractedActivityRequestDTO(
                null,
                TIME_NOW,
