...
class ActivitiesCalendarTest {
    ...
    private val projectRoleInDays = projectRoleInMinutes.copy(timeInfo = TimeInfo(projectRoleInMinutes.getMaxTimeAllowedByYear(), projectRoleInMinutes.getMaxTimeAllowedByActivity(), TimeUnit.DAYS))
