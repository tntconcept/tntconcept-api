...
import com.autentia.tnt.binnacle.validators.CreateVacationValidation.FailureReason.VACATION_RANGE_CLOSED
import com.autentia.tnt.binnacle.validators.CreateVacationValidation.FailureReason.VACATION_BEFORE_HIRING_DATE
import com.autentia.tnt.binnacle.validators.CreateVacationValidation.FailureReason.VACATION_REQUEST_EMPTY
import com.autentia.tnt.binnacle.validators.CreateVacationValidation.FailureReason.VACATION_REQUEST_OVERLAPS
import com.autentia.tnt.binnacle.validators.CreateVacationValidation.FailureReason.INVALID_DATE_RANGE
...
internal class PrivateHolidayPeriodCreateUseCaseTest {
    ...
    private val privateHolidayPeriodCreateUseCase =
        PrivateHolidayPeriodCreateUseCase(vacationService, userService, vacationValidator, CreateVacationResponseConverter(), RequestVacationConverter(), vacationMailService)
    ...
    fun `create new vacation period sending the email`() {
        ...
        verify(vacationMailService, times(1)).sendRequestVacationsMail(USER.username, TODAY, TOMORROW, "Lorem ipsum...", ENGLISH)
    }
    ...
    private companion object{
        ...
        private val vacationForRangeClosed = RequestVacationDTO(startDate= TODAY_TWO_YEARS_AGO,endDate = TOMORROW_TWO_YEARS_AGO)
        private val vacationRequestBeforeHiringDate = RequestVacationDTO(startDate= USER.hiringDate.minusDays(3), endDate = USER.hiringDate.minusDays(2))
        ...
        private val moreThanFiveDaysNextYearVacation = RequestVacationDTO(startDate = TODAY_NEXT_YEAR, endDate = SIX_DAYS_NEXT_YEAR)
