...
internal class ActivityDateConverterTest {
    ...
    private companion object {
        ...
        private val PROJECT_ROLE = ProjectRole(10L, "Workable Project role", RequireEvidence.NO, PROJECT, 0, true)
        private val PROJECT_ROLE_NOT_WORKABLE = ProjectRole(6L, "Project role not workable", RequireEvidence.WEEKLY, PROJECT, 0, false)
