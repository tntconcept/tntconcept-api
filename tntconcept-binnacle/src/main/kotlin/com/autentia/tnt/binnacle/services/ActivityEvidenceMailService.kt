...
internal class ActivityEvidenceMailService(
        ...
        private val messageBuilder: ActivityEvidenceMessageBuilder,
        private val appProperties: AppProperties) {


    fun sendEmail(organizationName: String, projectName: String, projectRoleNames: Set<String>, toUserEmail: String, locale: Locale) {
        ...
        mailService.send(appProperties.mail.from, listOf(toUserEmail), subject, body).onFailure { logger.error("Error sending activity evidence email", it) }
    }
...
@Singleton
internal class ActivityEvidenceMessageBuilder(private val messageSource: MessageSource) {
    ...
    fun buildBody(locale: Locale, organizationName: String, projectName: String, projectRoleNames: Set<String>): String =
    ...
    private fun getRoleLines(organizationName: String, projectName: String, projectRoleNames: Set<String>): String =
            projectRoleNames.map { "$organizationName - $projectName - $it" }.joinToString("\n")
