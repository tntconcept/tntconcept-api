...
internal class SearchControllerIT {
    ...
    private companion object {
        ...
        private val TRAINING = ProjectResponseDTO(1, "Formación Autentia", true, false, ProjectBillingTypes().getProjectBillingType("NO_BILLABLE"),AUTENTIA.id, LocalDate.now())
