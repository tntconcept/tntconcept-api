...
internal class ActivityController(
    ...
    @Operation(
            ...
            responses = [ApiResponse(
                    responseCode = "200",
                    description = "Successful retrieval of the activity evidence.",
                    content = [Content(
    ...
    @Operation(
            ...
            responses = [ApiResponse(
                    responseCode = "200", description = "Activity created successfully",
                    content = [Content(
